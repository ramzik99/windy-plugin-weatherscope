...
const source = ts.transpileModule(readFileSync(new URL('../../src/winter/placeAutocomplete.ts',import.meta.url),'utf8'),{compilerOptions:{target:ts.ScriptTarget.ES2022,module:ts.ModuleKind.ESNext}}).outputText;
