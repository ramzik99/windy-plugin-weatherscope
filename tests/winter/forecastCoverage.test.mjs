...
let s=readFileSync(new URL('../../src/winter/forecastCoverage.ts',import.meta.url),'utf8').replace("import { PRECIP_THRESHOLD_MM_3H } from './precip';",'const PRECIP_THRESHOLD_MM_3H=0.1;');
