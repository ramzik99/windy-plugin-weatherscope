...
const source=ts.transpileModule(readFileSync(new URL('../../src/winter/automaticRefresh.ts',import.meta.url),'utf8'),{compilerOptions:{target:ts.ScriptTarget.ES2022,module:ts.ModuleKind.ESNext}}).outputText;
