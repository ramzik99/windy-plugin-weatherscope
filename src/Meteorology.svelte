...
<details class="meteorology">
 ...
 <p>Temperature · same point and exact time. Model differences are not probabilities; Meteoblue may incorporate these models.</p>{#each comparisonErrors as error}<p class="error">{error}</p>{/each}
</details>
<style>
